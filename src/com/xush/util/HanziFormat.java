 ...
 * 
 * @author Luo Zhong(luozh@esensoft.com)
 * @version 1.0
 * 
 */
public class HanziFormat {

  private final static String[] digit_s = { "○", "一", "二", "三", "四", "五", "六", "七", "八", "九" };

  private final static String[] digit_t = { "零", "壹", "贰", "叁", "肆", "伍", "陆", "柒", "捌", "玖" };

  private static final String unit_s[] = { "", "十", "百", "千", "万", "十", "百", "千", "亿", "十", "百", "千", "兆", "十", "百",
      "千"};

  private static final String unit_t[] = { "", "拾", "佰", "仟", "万", "拾", "佰", "仟", "亿", "拾", "佰", "仟", "兆", "拾", "佰",
      "仟" };

  private final static long[] mask = { 1L, 10L, 100L, 1000L, 10000L, 100000L, 1000000L, 10000000L, 100000000L,
      1000000000L, 10000000000L, 100000000000L, 1000000000000L, 10000000000000L, 100000000000000L, 1000000000000000L,
      10000000000000000L, 100000000000000000L, 1000000000000000000L};
  
  /**
   * 将长整型数字转换为汉字大写数字字符串。
   * 例如：HanziFormat.toHanZiTr(1253654) --> "壹佰贰拾伍万叁仟陆佰伍拾肆"
   * 
  ...
  /**
   * 将长整型数字转换为汉字小写数字字符串。
   * 例如：HanziFormat.toHanZiSi(1253654) --> "一百二十五万三千六百五十四"
   * 
   * @param x 需要转换的数字，该数字包含的位数不能超过15，否则会出现转换异常。
   * @return 数字转换后的汉字字符串。
   */
